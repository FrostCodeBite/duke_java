...
public class MarkovRunner2 {
    ...
    public void runEffecientMarkov() { 
        FileResource fr = new FileResource(); 
        String st = fr.asString(); 
        st = st.replace('\n', ' '); 
        // String st = "this is a test yes this is wow";
    ...
    public static void main(String[] args) {
        MarkovRunner2 obj = new MarkovRunner2();
        // obj.runMarkov();
        obj.runEffecientMarkov();
